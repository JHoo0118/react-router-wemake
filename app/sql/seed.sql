-- Seed categories
 ...
 VALUES
   ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', '67fb92ed-9402-47e3-b864-a28b4a66dc24', 1, NOW(), NOW()),
   ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', '67fb92ed-9402-47e3-b864-a28b4a66dc24', 2, NOW(), NOW()),
   ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', '67fb92ed-9402-47e3-b864-a28b4a66dc24', 3, NOW(), NOW()),
   ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', '67fb92ed-9402-47e3-b864-a28b4a66dc24', 4, NOW(), NOW()),
   ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', '67fb92ed-9402-47e3-b864-a28b4a66dc24', 5, NOW(), NOW());
 
 -- Seed product upvotes (bridge table)
 INSERT INTO product_upvotes (product_id, profile_id)
 VALUES (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24');
 
 -- Seed reviews
 INSERT INTO reviews (product_id, profile_id, rating, review, created_at, updated_at)
 VALUES
   (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 5, 'Excellent developer tool!', NOW(), NOW()),
   (2, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 4, 'Great design features', NOW(), NOW()),
   (3, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 5, 'Amazing marketing automation', NOW(), NOW()),
   (4, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 4, 'Very helpful coding assistant', NOW(), NOW()),
   (5, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 5, 'Powerful visualization tool', NOW(), NOW());
 ...
 VALUES
   ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', NOW(), NOW()),
   ('Design Tips and Tricks', 'Essential design principles...', 2, '67fb92ed-9402-47e3-b864-a28b4a66dc24', NOW(), NOW()),
   ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, '67fb92ed-9402-47e3-b864-a28b4a66dc24', NOW(), NOW()),
   ('Launching Your First Product', 'Steps to a successful product launch...', 4, '67fb92ed-9402-47e3-b864-a28b4a66dc24', NOW(), NOW()),
   ('AI in Modern Development', 'How AI is changing development...', 5, '67fb92ed-9402-47e3-b864-a28b4a66dc24', NOW(), NOW());
 ...
 VALUES
   (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'Great post about DevTool Pro!', NOW(), NOW()),
   (2, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'These design tips are very helpful', NOW(), NOW()),
   (3, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'Marketing automation is crucial', NOW(), NOW()),
   (4, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'Launch strategy is on point', NOW(), NOW()),
   (5, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'AI is indeed transforming development', NOW(), NOW());
 
 -- Seed gpt ideas
 INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
 VALUES
   ('AI-powered code review assistant', 0, '67fb92ed-9402-47e3-b864-a28b4a66dc24', NOW()),
 ...
 VALUES (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', NOW());
 
 -- Seed messages
 INSERT INTO messages (message_room_id, sender_id, content, created_at)
 VALUES
   (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'Hello! Interested in collaboration', NOW()),
   (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'Let''s discuss the project details', NOW()),
   (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'What''s your availability?', NOW()),
   (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'I can start next week', NOW()),
   (1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'Great, looking forward to working together', NOW());
 
 -- Seed notifications
 INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
 VALUES
   ('67fb92ed-9402-47e3-b864-a28b4a66dc24', 1, NULL, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'review', NOW()),
   ('67fb92ed-9402-47e3-b864-a28b4a66dc24', NULL, 1, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'reply', NOW()),
   ('67fb92ed-9402-47e3-b864-a28b4a66dc24', NULL, NULL, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'follow', NOW()),
   ('67fb92ed-9402-47e3-b864-a28b4a66dc24', NULL, 2, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'mention', NOW()),
   ('67fb92ed-9402-47e3-b864-a28b4a66dc24', 2, NULL, '67fb92ed-9402-47e3-b864-a28b4a66dc24', 'review', NOW());
